...
THREEx.createPoolBall	= function(opts){
	...
	if( opts.ballDesc === 'cue' ){
		...
		// sanity check
//		console.assert(Object.keys(fillStylePerDesc).indexOf(opts.ballDesc) !== -1); //fails unnecessary
		// build the texture
		var fillStyle	= fillStylePerDesc[opts.ballDesc];
		var texture	= THREEx.createPoolBall.ballTexture(opts.ballDesc, opts.striped,
